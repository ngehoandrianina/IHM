...
const DetailPret = ({show,setShow,isOpen, onClose, user}) => {
    const [id,setid] = useState('')
    const Terminer =(e)=>{
        e.preventDefault()
        MySwal.fire({
            title: 'Tout les Materiel sont retourner ?',
    ...
    <div className='absolute top-0 left-0 bg-[#14080871] w-full h-full flex items-center justify-center  p-4'>
     ...
     <div className='w-[80%] h-[100%] flex flex-col items-center justify-between'>
      <div className=' w-[100%] py-4 '>
        <h1 className='text-center text-xl'>Details des materielle Emprunter par {user.username}</h1>
